...
use Ethemkizil\EArsivFatura\Service;
...
file_put_contents(__DIR__ . "/index.php", $ivoice_export); // olusan faturayi example dizinine kaydetmek icin kullanabilirsiniz.
